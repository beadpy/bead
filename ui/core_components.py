...
class Component:
    ...
    def __init__(self, style: Optional[str] = None, custom_style: Optional[str] = None, **kwargs):
        self.props = kwargs
        self.props['style'] = style
        self.props['custom_style'] = custom_style
...
class Page(Component):
    def __init__(self, title: str, body: List[Component], style: Optional[str] = None, custom_style: Optional[str] = None, meta: Optional[Dict[str, str]] = None, **kwargs):
        super().__init__(title=title, body=body, style=style, custom_style=custom_style, meta=meta, **kwargs)
